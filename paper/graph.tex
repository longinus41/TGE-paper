...
\textcolor{red}{In this section, we illustrate our inferring approach as a 3-phases workflow. Then the differences from other graphs analysis methods is discussed.} 

%Our identity inferring method is based on graph embedding techniques. } 
...
\begin{figure}[htbp]
	\centering
	\subfigure[High-order proximity]{
		\label{fig:high_order}
