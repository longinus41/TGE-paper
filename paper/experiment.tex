...
\begin{figure*}
\centering     %%% not \center
\subfigure[Multi-Adjacent Matrices]{\label{fig:a}\includegraphics[width=42mm]{fig/multi_relation_result}}
\subfigure[Second-order Proximity]{\label{fig:b}\includegraphics[width=42mm]{fig/second_order_result}}
\subfigure[Asymmetric Proximity]{\label{fig:a}\includegraphics[width=42mm]{fig/asymmetric_result}}
\subfigure[Time-density Matrices]{\label{fig:a}\includegraphics[width=42mm]{fig/time_density_result}}
\caption{Visualization of nodes with different labels in 2-dimensional space.}
