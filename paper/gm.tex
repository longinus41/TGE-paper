...
\begin{table}[!t]
  ...
  \begin{tabular}{ll}
    ...
    \hline
    \vspace{1mm}\\[-3mm]
    $G_t$      &   \tabincell{l}{The transaction graph}\\
    \vspace{1mm}
...
\paragraph{Adjacency matrices} Different from other networks, edges in transaction graph stand for heterogeneous activities such as money transfer, contract creation and contract invocation. Obviously, such %multi-relations can not be measured in a uniform weighted model.
