...
\paragraph{Account representations} We use a feature matrix $X \in \mathbb{R}^{N \times d}$ to encode the overall structural and additional information of accounts. There are $d$ features including:
