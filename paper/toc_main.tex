...
{I$^2$GL: An Identity Inference Approach for Blockchain based on Graph Deep Learning}
...
\begin{IEEEkeywords}
Cryptocurrency, Blockchain, \textcolor{red}{Deanonymization}, Graph deep learning
\end{IEEEkeywords}
