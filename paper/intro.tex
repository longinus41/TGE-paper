...
(1) To the best of our knowledge, we are the first to apply graph deep learning based on GCN for identity inference on \textcolor{red}{blockchain}. 

(2) Motivated by special features of transaction graph, we propose several novel designs to enhance the performance of traditional GCN.
